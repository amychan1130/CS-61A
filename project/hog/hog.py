...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    if score >= 10:
        return 1 + max((score // 10) % 10, score % 10)
    else:
        return 1 + score
    # END PROBLEM 2
...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    if score0 !=1 and score1 != 1 and score0 !=0 and score1 != 0:
        if score1 > score0:
            n = score1//2 +1
        else:
            n = score0//2 +1
...
def both(f, g):
    ...
    """
    # BEGIN PROBLEM 6
    def combine_function(score0, score1):
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while num_rolls <= 10:
        if averaged_dice(num_rolls,dice) > point:
            point = averaged_dice(num_rolls,dice)
            max_scoreing_roll = num_rolls
        num_rolls +=1
    return max_scoreing_roll
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    point_added = free_bacon(opponent_score)
    if score > opponent_score:
        if point_added >= margin and is_swap(score+point_added, opponent_score) == False:
            return 0
    else:
        if point_added >= margin or is_swap(score+point_added, opponent_score) == True:
            return 0
